...
db = connection.myosotis.registrocrawler3
resultsCrawler3 = db.find()
...
db = connection.myosotis.registrocrawler7
resultsCrawler7 = db.find()

db = connection.myosotis.registrocrawler8
resultsCrawler8 = db.find()

db = connection.myosotis.registrocrawler9
resultsCrawler9 = db.find()
...
def load():
    conn_string = [line.rstrip('\n') for line in open('config.txt')]
    conn = psycopg2.connect(conn_string[0])
    cursor = conn.cursor()
    print ("Connected!")
